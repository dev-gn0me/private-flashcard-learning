...
export const guideSections: GuideSection[] = [
  {
    ...
    intro:
      "Lernen ist ein Prozess. Am Anfang wirkt vieles langsam und anstrengend, aber mit Regelmäßigkeit wird es leichter.",
    items: [
  ...
  },
  {
    ...
    intro:
      "Eine gute Karte testet genau eine klare Sache und ist schnell beantwortbar.",
    items: [
  ...
  },
  {
    ...
    intro:
      "Eine gute Zusammenfassung ist geordnet, knapp und zeigt Zusammenhänge.",
    items: [
  ...
  },
  {
    ...
    intro:
      "A5 lohnt sich für kompakte Übersichten, nicht für ganze Kapitel in Fließtext.",
    items: [
      ...
      "Es hilft, die Bilder selber auf den Karteikarten zu malen und beschriften - wenn möglich.",
    ],
  },
];
